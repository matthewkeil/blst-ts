  ...
  describe("constructor", () => {
    ...
    describe("Signature.deserialize()", () => {
      ...
      it("should take uncompressed byte arrays", () => {
        expectHex(Signature.deserialize(signatureExample.p2).serialize(false), signatureExample.p2);
      });
      it("should take compressed byte arrays", () => {
        expectHex(Signature.deserialize(signatureExample.p2Comp).serialize(), signatureExample.p2Comp);
      });
    });
    describe("methods", () => {
      describe("serialize", () => {
