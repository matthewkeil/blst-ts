  ...
  describe("constructors", () => {
    ...
    describe("deserialize", () => {
      ...
      it("should take uncompressed byte arrays", () => {
        expectHex(PublicKey.deserialize(publicKeyExample.p1).serialize(false), publicKeyExample.p1);
      });
      it("should take compressed byte arrays", () => {
        expectHex(PublicKey.deserialize(publicKeyExample.p1Comp).serialize(true), publicKeyExample.p1Comp);
      });
